...
public enum Conf{
	...
	// new tests created
	JCONF06(Map.JMAP01,0,0,0,0), // Departure is the destination
	JCONF07(Map.JMAP00,2,2,1,1), // Departure is a land
	JCONF08(Map.JMAP00,1,1,2,2), // Destination is a land
	JCONF09(Map.JMAP01,3,3,1,1), // Departure out of bounds
	JCONF10(Map.JMAP01,1,1,3,3), // Destination out of bounds
	...
	CONF10(Map.MAP2,5,5,2,3), // fail
	CONF11(Map.MAP2,2,3,1,4), // fail
